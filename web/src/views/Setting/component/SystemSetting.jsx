            ...
            <Stack spacing={2}>
                    ...
                    <Grid container spacing={{ xs: 3, sm: 2, md: 4 }}>
                        <Grid xs={12}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor="ServerAddress">
                                    {t('setting_index.systemSettings.generalSettings.serverAddress')}
                                </InputLabel>
                                <OutlinedInput
                                    id="ServerAddress"
                                    name="ServerAddress"
                    ...
                    <Grid container spacing={{ xs: 3, sm: 2, md: 4 }}>
                        ...
                        <Grid xs={12} md={3}>
                            <FormControlLabel
                                ...
                                control={
                                    <Checkbox
                                        checked={inputs.LarkAuthEnabled === 'true'}
                                        onChange={handleInputChange}
                        ...
                        <Grid xs={12} md={3}>
                            <FormControlLabel
                                ...
                                control={
                                    <Checkbox
                                        checked={inputs.OIDCAuthEnabled === 'true'}
                                        onChange={handleInputChange}
                ...
                >
                    <Grid container spacing={{ xs: 3, sm: 2, md: 4 }}>
                        ...
                        <Grid xs={12} md={6}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor="OIDCClientId">
                                    {t('setting_index.systemSettings.configureOIDCAuthorization.clientId')}
                                </InputLabel>
                                <OutlinedInput
                                    id="OIDCClientId"
                                    name="OIDCClientId"
                        ...
                        <Grid xs={12} md={6}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor="OIDCIssuer">
                                    {t('setting_index.systemSettings.configureOIDCAuthorization.issuer')}
                                </InputLabel>
                                <OutlinedInput
                                    id="OIDCIssuer"
                                    name="OIDCIssuer"
                        ...
                        <Grid xs={12} md={6}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor="OIDCScopes">
                                    {t('setting_index.systemSettings.configureOIDCAuthorization.scopes')}
                                </InputLabel>
                                <OutlinedInput
                                    id="OIDCScopes"
                                    name="OIDCScopes"

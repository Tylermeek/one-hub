                        ...
                        >
                            ...
                            >
                                <FormControlLabel
                                    control={
                                        <Switch
                                            checked={addToMapping}
                                            onChange={(e) => setAddToMapping(e.target.checked)}
                                            color="primary"
                                        />
                                    }
                                    label={
                            ...
                            <Collapse in={addToMapping}>
                                <Box sx={{ mt: 1, display: 'flex', flexDirection: 'column', gap: { xs: 1.5, sm: 2 } }}>
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Switch
                                                checked={removePrefixOrSuffix}
                                                onChange={(e) => setRemovePrefixOrSuffix(e.target.checked)}
                                            />
                                        }
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Switch
                                                checked={filterMappedModels}
                                                onChange={(e) => setFilterMappedModels(e.target.checked)}
                                            />
                                        }
                                    ...
                                    <FormControlLabel
                                        control={
                                            <Switch checked={overwriteMappings} onChange={(e) => setOverwriteMappings(e.target.checked)} />
                                        }
                                        label={
                                            <Box sx={{ display: 'flex', alignItems: 'center' }}>

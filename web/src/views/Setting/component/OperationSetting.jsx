        ...
        <Stack spacing={2}>
                ...
                <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                    <Stack direction={{ sm: 'column', md: 'row' }} spacing={{ xs: 3, sm: 2, md: 4 }}>
                        <FormControl fullWidth>
                            <InputLabel htmlFor="TopUpLink">
                                {t('setting_index.operationSettings.generalSettings.topUpLink.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="TopUpLink"
                                name="TopUpLink"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="ChatLink">
                                {t('setting_index.operationSettings.generalSettings.chatLink.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="ChatLink"
                                name="ChatLink"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="QuotaPerUnit">
                                {t('setting_index.operationSettings.generalSettings.quotaPerUnit.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="QuotaPerUnit"
                                name="QuotaPerUnit"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="RetryTimes">
                                {t('setting_index.operationSettings.generalSettings.retryTimes.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="RetryTimes"
                                name="RetryTimes"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="RetryTimeOut">
                                {t('setting_index.operationSettings.generalSettings.retryTimeOut.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="RetryTimeOut"
                                name="RetryTimeOut"
                ...
                <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                    ...
                    >
                        <FormControlLabel
                            ...
                            control={
                                <Checkbox checked={inputs.MjNotifyEnabled === 'true'} onChange={handleInputChange} name="MjNotifyEnabled" />
                            }
                        />
                        <FormControlLabel
                            sx={{ marginLeft: '0px' }}
                    ...
                    <Stack spacing={2}>
                        ...
                        <FormControl>
                            <InputLabel htmlFor="CFWorkerImageKey">
                                {t('setting_index.operationSettings.otherSettings.CFWorkerImageUrl.key')}
                            </InputLabel>
                            <OutlinedInput
                                id="CFWorkerImageKey"
            ...
            <SubCard title={t('setting_index.operationSettings.logSettings.title')}>
                <Stack direction="column" justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                    <FormControlLabel
                        ...
                        control={
                            <Checkbox checked={inputs.LogConsumeEnabled === 'true'} onChange={handleInputChange} name="LogConsumeEnabled" />
                        }
                    />
                    <FormControl>
            ...
            <SubCard title={t('setting_index.operationSettings.quotaSettings.title')}>
                <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                    <Stack direction={{ sm: 'column', md: 'row' }} spacing={{ xs: 3, sm: 2, md: 4 }}>
                        <FormControl fullWidth>
                            <InputLabel htmlFor="QuotaForNewUser">
                                {t('setting_index.operationSettings.quotaSettings.quotaForNewUser.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="QuotaForNewUser"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="QuotaForInviter">
                                {t('setting_index.operationSettings.quotaSettings.quotaForInviter.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="QuotaForInviter"
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="QuotaForInvitee">
                                {t('setting_index.operationSettings.quotaSettings.quotaForInvitee.label')}
                            </InputLabel>
                            <OutlinedInput
                                id="QuotaForInvitee"
            ...
            <SubCard title={t('setting_index.operationSettings.paymentSettings.title')}>
                <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                    <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                        ...
                        <Stack direction={{ sm: 'column', md: 'row' }} spacing={{ xs: 3, sm: 2, md: 4 }}>
                            <FormControl fullWidth>
                                <InputLabel htmlFor="PaymentUSDRate">
                                    {t('setting_index.operationSettings.paymentSettings.usdRate.label')}
                                </InputLabel>
                                <OutlinedInput
                                    id="PaymentUSDRate"
                                    name="PaymentUSDRate"
                            ...
                            <FormControl fullWidth>
                                <InputLabel htmlFor="PaymentMinAmount">
                                    {t('setting_index.operationSettings.paymentSettings.minAmount.label')}
                                </InputLabel>
                                <OutlinedInput
                                    id="PaymentMinAmount"
            ...
            <SubCard title={t('setting_index.operationSettings.safetySettings.title')}>
                <Stack spacing={2}>
                    <Stack justifyContent="flex-start" alignItems="flex-start" spacing={2}>
                        ...
                        <FormControl fullWidth>
                            <InputLabel htmlFor="SafeToolName">
                                {t('setting_index.operationSettings.safetySettings.safeToolName.label')}
                            </InputLabel>
                            <Select
                                id="SafeToolName"
                                name="SafeToolName"

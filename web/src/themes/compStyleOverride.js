        ...
        MuiPaper: {
            ...
            styleOverrides: {
                root: {
                    ...
                    borderRadius: '14px',
                    boxShadow:
                        theme.mode === 'dark' ? '0 2px 8px 0 rgba(0,0,0,0.2)' : '0 1px 3px 0 rgba(0,0,0,0.1), 0 1px 2px 0 rgba(0,0,0,0.06)'
                },
                rounded: {
                ...
                elevation2: {
                    boxShadow:
                        theme.mode === 'dark'
                            ? '0 3px 12px 0 rgba(0,0,0,0.22)'
                            : '0 3px 6px -1px rgba(0,0,0,0.1), 0 2px 4px -1px rgba(0,0,0,0.06)'
                }
            }
        },
        MuiCard: {
                    ...
                    '&:hover': {
                        boxShadow:
                            theme.mode === 'dark'
                                ...
                                : '0 8px 14px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05)'
                    },

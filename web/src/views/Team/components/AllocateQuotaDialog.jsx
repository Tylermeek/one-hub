              ...
              <AlertDescription>
                {unlimited ? (
                  <>
                    ...
                    {teamData?.owner_quota && <span className="font-medium">（{renderQuota(teamData.owner_quota, 2)}）</span>}。
                  </>
                ) : (
            ...
            {teamData && (
              <div className="p-4 bg-muted rounded-lg space-y-2 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{teamData.unlimited_quota ? '无限制' : renderQuota(teamData.quota || 0, 2)}</span>
                </div>
                <div className="flex justify-between">

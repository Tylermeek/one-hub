                                    ...
                                    >
                                        ...
                                        {touched.base_url && errors.base_url ? (
                                            ...
                                            <FormHelperText id="helper-tex-channel-base_url-label">
                                                {' '}
                                                {customizeT(inputPrompt.base_url)}{' '}
                                            </FormHelperText>
                                        )}
                                    </FormControl>
                                )}
                                                ...
                                                const event = {
                                                    target: {
                                                        ...
                                                        value: value.map((item) =>
                                                            typeof item === 'string'
                                                                ? { id: item, group: t('channel_edit.customModelTip') }
                                                                : item
                                                        )
                                                    }
                                                };
                      ...
                      {t('channel_edit.inputAllModel')}
                                ...
                                {inputPrompt.only_chat && (
                                    <FormControl fullWidth>
                                        ...
                                        />
                                        <FormHelperText id="helper-tex-only_chat_model-label">
                                            {' '}
                                            {customizeT(inputPrompt.only_chat)}{' '}
                                        </FormHelperText>
                                    </FormControl>
                                )}
                                {inputPrompt.pre_cost && (
                                    <FormControl
                                        fullWidth
                                        error={Boolean(touched.pre_cost && errors.pre_cost)}
                                        sx={{ ...theme.typography.otherInput }}
                                    >
                                        ...
                                        {touched.pre_cost && errors.pre_cost ? (
                                            ...
                                            <FormHelperText id="helper-tex-channel-pre_cost-label">
                                                {' '}
                                                {customizeT(inputPrompt.pre_cost)}{' '}
                                            </FormHelperText>
                                        )}
                                    </FormControl>
                                )}

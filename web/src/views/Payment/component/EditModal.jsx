                ...
                <Formik initialValues={inputs} enableReinitialize validationSchema={getValidationSchema(t)} onSubmit={submit}>
                    {({ errors, handleBlur, handleChange, handleSubmit, touched, values, isSubmitting }) => (
                        <form noValidate onSubmit={handleSubmit}>
                            ...
                            <FormControl
                                fullWidth
                                error={Boolean(touched.notify_domain && errors.notify_domain)}
                            ...
                            >
                                ...
                                {touched.notify_domain && errors.notify_domain ? (
                                    ...
                                    <FormHelperText id="helper-tex-notify_domain-label">
                                        {' '}
                                        {t('payment_edit.notifyDomainTip')}{' '}
                                    </FormHelperText>
                                )}
                            </FormControl>
                            ...
                            <FormControl
                                fullWidth
                                error={Boolean(touched.fixed_fee && errors.fixed_fee)}
                                sx={{ ...theme.typography.otherInput }}
                            >
                            ...
                            <FormControl
                                fullWidth
                                error={Boolean(touched.percent_fee && errors.percent_fee)}
                                sx={{ ...theme.typography.otherInput }}
                            >
                                <InputLabel htmlFor="channel-percent_fee-label">
                            ...
                            >
                                ...
                                {touched.currency && errors.currency ? (
                                    ...
                                    <FormHelperText id="helper-tex-channel-currency-label">
                                        {' '}
                                        {t('payment_edit.currencyTip')}{' '}
                                    </FormHelperText>
                                )}
                            </FormControl>

        ...
        <>
            <TableRow tabIndex={item.id}>
                ...
                {columnVisibility.message && (
                    <TableCell sx={{ p: '10px 8px' }}>
                        {viewInput(item, t, totalInputTokens, totalOutputTokens, show, tokenDetails)}
                    </TableCell>
                )}
                ...
                {columnVisibility.quota_source && <TableCell sx={{ p: '10px 8px' }}>{renderQuotaSource(item)}</TableCell>}

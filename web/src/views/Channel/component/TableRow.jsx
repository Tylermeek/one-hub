                                                        ...
                                                        <Table size="small" sx={{ '& .MuiTableCell-root': { py: 1, px: 1.5 } }}>
                                                            <TableHead sx={{ bgcolor: 'background.neutral' }}>
                                                                <TableRow>
                                                                    <TableCell
                                                                        padding="checkbox"
                                                                        sx={{ pl: 1, width: '40px', textAlign: 'center' }}
                                                                    >
                                                                        <Checkbox
                                                                            indeterminate={
                                                                                selectedChannels.length > 0 &&
                                                                                selectedChannels.length < tagChannels.length
                                                                            }
                                                                            checked={
                                                                                tagChannels.length > 0 &&
                                                                                selectedChannels.length === tagChannels.length
                                                                ...
                                                                {tagChannels
                                                                    ...
                                                                    .map((channel) => (
                                                                        <TableRow key={channel.id} hover>
                                                                            ...
                                                                            <TableCell sx={{ textAlign: 'center' }}>
                                                                                <Tooltip
                                                                                    title={t('channel_row.clickUpdateQuota')}
                                                                                    placement="top"
                                                                                >
                                                                                    <Box
                                                                                        sx={{ cursor: 'pointer' }}
                                                                                        onClick={() =>
                                                                                            manageChannel(channel.id, 'update_balance')
                                                                                        }
                                                                                    >
                                                                                        <Stack
                                                                                            direction="column"
                                                                            ...
                                                                            <TableCell sx={{ textAlign: 'center' }}>
                                                                                <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                                                                                    <TextField
                                                                                        ...
                                                                                        onChange={(e) =>
                                                                                            handleTagChannelPriorityChange(
                                                                                                channel.id,
                                                                                                                ...
                                                                                                                manageChannel(
                                                                                                                    ...
                                                                                                                    .then(({ success }) => {
                                                                                                                        if (success) {
                                                                                                                            ...
                                                                                                                            showSuccess(
                                                                                                                                t(
                                                                                                                                    'channel_row.priorityUpdateSuccess'
                                                                                                                                )
                                                                                                                            );
                                                                                                                        }
                                                                                                                    })
                                                                                                                    .catch((error) => {
                                                                                                                        showError(
                                                                                                                            t(
                                                                                                                                'channel_row.priorityUpdateError',
                                                                                                                                {
                                                                                                                                    message:
                                                                                                                                        error.message
                                                                                                                                }
                                                                            ...
                                                                            <TableCell align="center">
                                                                                <Stack direction="row" spacing={1} justifyContent="center">
                                                                                    <Tooltip
                                                                                        title={t('channel_row.testModels')}
                                                                                        placement="top"
                                                                                    >
                                                                                        <IconButton
                                                                                            size="small"

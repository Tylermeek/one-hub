...
const TooltipProvider = React.forwardRef(({ delayDuration = 0, ...props }, ref) => {
    return <TooltipPrimitive.Provider ref={ref} data-slot="tooltip-provider" delayDuration={delayDuration} {...props} />;
});
